...
Panda Energy maneja datos sensibles de clientes, contratos y consumos energéticos. La plataforma está diseñada con la seguridad y la privacidad como prioridades desde el primer día, cumpliendo con la normativa europea de protección de datos.
...
Los contratos firmados a través de Panda Energy tienen plena validez legal en toda la Unión Europea:
